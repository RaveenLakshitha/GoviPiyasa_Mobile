...
class OrganicFertilizerList extends StatefulWidget {
  @override
  _OrganicFertilizerListState createState() => _OrganicFertilizerListState();
}

class _OrganicFertilizerListState extends State<OrganicFertilizerList>
  ...
  void itemCategory() async {
    ...
    try {
      final response = await get(Uri.parse("https://govi-piyasa-v-0-1.herokuapp.com/api/v1/items/getItemsByParentCategory/63116f7596b22674427884a8"));
