...
class expertmap extends StatefulWidget{
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<expertmap> {
        ...
        floatingActionButton: new FloatingActionButton(
            ...
            onPressed: (){
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ExpertForm(location:location,latlang:latlang.toString(),longitude: longitude.toString(),),
                  ));
