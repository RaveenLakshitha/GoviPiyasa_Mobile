...
class _ArchitectState extends State<Architect> {
  ...
  createArchitect(businessName,email,contact,description,motto,File file,File shopPic1,File shopPic2,File shopPic3,File pic) async {
    ...
    try {
      ...
      FormData formData=FormData.fromMap({
        ...
        "shopImages":await MultipartFile.fromFile(file.path, filename:fileName1),
        "shopImages":await MultipartFile.fromFile(file.path, filename:fileName2),
        "shopImages":await MultipartFile.fromFile(file.path, filename:fileName3),
                     ...
                     // Text('I accept the terms and conditions.'),
                          ...
                          onPressed: _isAcceptTermsAndConditions
                            ...
                            if (_formkey.currentState.validate()){
                             ...
                             // createArchitect( businessName, email, contact,description, motto,_image,_shopimg1,_shopimg2,_shopimg3,_image);
