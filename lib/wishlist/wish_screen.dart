      ...
      body: Padding(
        ...
        child: Column(
          children: [
                      ...
                      return Align(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 20,),
                            Text('Your wishlist is empty 😌' ,style: Theme.of(context).textTheme.headline5),
                            SizedBox(height: 20,),
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    InkWell(
                                                        onTap: (){
                                                          dbHelper1.delete(snapshot.data[index].id);
                                                          cart.removerCounter();
                                                ...
                                                SizedBox(height: 5,),
                                                Text(" "+r"Rs"+ snapshot.data[index].productPrice.toString() ,
                                                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),
                                                ),
                                                SizedBox(height: 5,),
                                                Align(
            ...
            Consumer<CartProvider1>(builder: (context, value, child){
              return Visibility(
